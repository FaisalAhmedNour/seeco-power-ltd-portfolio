      ...
      <section className="mx-auto max-w-310 px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <aside className="hidden lg:block lg:col-span-1">
            <div className="bg-white p-4 shadow-xs border border-gray-150 rounded-lg sticky top-8 max-h-[calc(100vh-3rem)] overflow-y-auto">
            ...
            {data.sections.map((section) => {
              ...
              return (
                <section
                  ...
                  id={section.id}
                  className={[
                    "scroll-mt-28 pb-8 border-b border-gray-150 last:border-b-0",
