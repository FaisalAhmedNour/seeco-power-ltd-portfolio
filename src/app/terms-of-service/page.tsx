...
export default function TermsOfServicePage() {
  ...
  const rawMarkdown = policies
    ? (language === "bn" ? policies.termsBn : policies.termsEn)
    : "";
  const data = (rawMarkdown
    ? parseMarkdownToPolicy(rawMarkdown, language === "bn" ? "শর্তাবলী" : "Terms of Service")
    : termsOfServiceContent[language]) as PolicyContent;
